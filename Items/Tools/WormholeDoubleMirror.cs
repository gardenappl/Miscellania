...
namespace GoldensMisc.Items.Tools
{
	public class WormholeDoubleMirror : ModItem
	{
		...
		public override void PostDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
		{
			...
			spriteBatch.Draw(TextureAssets.Item[ItemID.MagicMirror].Value, position, frame, Color.White * alpha, 0f, origin, scale, 0, 0f);
		}
		...
		public override bool PreDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, ref float rotation, ref float scale, int whoAmI)
		{
			...
			float alpha = (float)Math.Sin((float)DateTime.Now.TimeOfDay.TotalMilliseconds / 500f) / 2f + 0.5f;
			spriteBatch.Draw(TextureAssets.Item[ItemID.MagicMirror].Value, Item.Center - Main.screenPosition, null, lightColor * alpha, rotation, Item.Size / 2, scale, 0, 0f);
			return false;
		}
